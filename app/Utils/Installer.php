...
class Installer
{ 
    private static $minPhpVersion = '8.1.0';
    ...
    public static function checkServerRequirements()
    {
		...
		if (phpversion() < self::$minPhpVersion) {
            $requirements[] = 'Minimum PHP Version 8.0.1 required';
        }
    ...
    public static function finalTouches()
    {
        ...
        static::updateEnv([
            ...
            'APP_INSTALLED' =>  'true',
            'APP_ENV'     => $request->mode == 'production' ? 'production' : 'local',
            'APP_DEBUG'     => $request->mode == 'production' ? 'false' : 'true',
            'APP_URL'     =>  url('/'),
