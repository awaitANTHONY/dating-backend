<form method="post" class="ajax-submit" autocomplete="off" action="{{ route('gifts.store') }}" enctype="multipart/form-data">
	@csrf
	<div class="row">
		...
		<div class="col-md-12">
			<div class="form-group">
				...
				<input type="number" name="coin" class="form-control" value="{{ old('coin') }}" required min="1">
			</div>
		</div>
		<div class="col-md-12">
			<div class="form-group">
