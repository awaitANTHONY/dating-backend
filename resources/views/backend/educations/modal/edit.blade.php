<form method="post" class="ajax-submit" autocomplete="off" action="{{ route('educations.update', $education->id) }}" enctype="multipart/form-data">
	@csrf
	@method('PUT')
	<div class="row">
		...
		<div class="col-md-12">
			<div class="form-group">
				...
				<select class="form-control select2" name="status" data-selected="{{ $education->status }}"  required>
