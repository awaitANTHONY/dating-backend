<form method="post" class="ajax-submit" autocomplete="off" action="{{ route('mood_suggestions.store') }}">
    @csrf
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                <label class="form-control-label">{{ _lang('Mood Text') }}</label>
                <input type="text" name="text" class="form-control" value="{{ old('text') }}" maxlength="50" required>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
