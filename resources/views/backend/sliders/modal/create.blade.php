<form method="post" class="ajax-submit" autocomplete="off" action="{{ route('sliders.store') }}" enctype="multipart/form-data">
	@csrf
	<div class="row">
		...
		<div class="col-md-12">
			<div class="form-group">
				...
				<input type="text" name="action_url" class="form-control" value="{{ old('action_url') }}">
			</div>
		</div>
		<div class="col-md-12">
			<div class="form-group">
