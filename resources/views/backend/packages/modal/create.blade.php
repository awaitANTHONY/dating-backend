<form class="ajax-submit2" method="post" autocomplete="off" action="{{ route('packages.store') }}">
	@csrf
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				<label class="control-label">Coins</label>
				<input type="number" class="form-control" name="coins" value="{{ old('coins') }}" required>
			</div>
		</div>
		<div class="col-md-12">
			<div class="form-group">
